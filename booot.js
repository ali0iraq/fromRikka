...
client.user.setGame(`+help | إذكر ربك اذا نسيت`,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : Jehad`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Jehad ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`with jihad`,"http://fb.com/techn7ical")
...
client.on('message', message => {
        ...
        .setTitle(`طبار`)
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=472152387935797248&permissions=8&scope=bot`)
        .setThumbnail("https://cdn.discordapp.com/avatars/472152387935797248/6c76e412f18c142dfd711d05fb363869.png?size=2048")        
     message.channel.sendEmbed(embed);
       }
   });
...
client.on('message', message => {
      ...
      if(!message.member.hasPermission('ADMINISTRATOR')) return message.reply('You Dont Have Perms ❌');
             ...
             READ_MESSAGES: false
              ...
              message.channel.send('تم إخفاء الرومات بنجاح ! ✅  ')
 }
});
...
client.on('message', message => {
      ...
      if(!message.member.hasPermission('ADMINISTRATOR')) return message.reply('❌');
             ...
             READ_MESSAGES: true
              ...
              message.channel.send('تم إظهار الرومات بنجاح')
 }
});
